...
async function submit(){
    ...
    <h1 class="font-bold text-[#5865F2] text-3xl md:text-4xl lg:text-5xl">Discord Verify, Payments!</h1>
    ...
    {/if}
    <button class="bg-[#5865F2] rounded-2xl py-2 px-4 hover:opacity-85 active:opacity-115" type="submit" onclick={submit}>Verify now.</button>

...
async function submit(){
    ...
    <p class="font-thin text-2xl">Please verify your discord account, to proceed to payment. If you do not, we at LumioINC. are sorry, but can't provide you with services!</p>
